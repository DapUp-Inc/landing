...
const ForBrands = () => {
  return (
    <section className="py-20 xl:py-24 xl2:py-28 2xl:py-32 bg-gradient-to-b from-dark-900 to-dark-800 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl xl2:max-w-[1400px] 2xl:max-w-[1600px] mx-auto px-6 lg:px-8 xl:px-10 xl2:px-12 2xl:px-16 relative z-10">
        ...
        >
          {[
            ...
            <div key={index} className="text-center">
              ...
              <div className="text-white font-semibold mb-1 xl2:text-lg">{stat.label}</div>
              <div className="text-gray-400 text-sm xl2:text-base">{stat.subtitle}</div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 xl2:mt-20 2xl:mt-24 text-center">
          <div className="bg-gradient-dark border border-white/10 rounded-2xl p-10 xl2:p-12 2xl:p-16">
